...
// export interface AccountExtType {
//   name: string;
//   creator: string;
...
// export interface AccountHistoryOperationType {
...
// export interface SteemPropsType {
...
// export interface PostingContentType {
