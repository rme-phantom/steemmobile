...
// import MediaControls, { PLAYER_STATES } from '@lucasolivamorim/react-native-media-controls';
...
const VideoPlayer = ({
  ...
  const onError = () => AppConstants.SHOW_TOAST('Error', 'Error while playing', 'error')
