...
import {rewardTypes} from '../components/basicComponents/RewardModal';
import {AppStrings} from '../constants/AppStrings';
import {Appearance} from 'react-native';
import {AppConstants} from '../constants/AppConstants';

export const empty_comment = (author, permlink): Post => {
...
export const empty_profile = (name: string): AccountExt => {
  ...
  return {
    ...
    observer_follows_author: 0,
    observer_ignores_author: 0,
    notification: AppConstants.DEFAULT_NOTIFICATION_SETTINGS,
  };
};
...
export const empty_settings = (): Setting => {
  ...
  return {
    ...
    languageTo: AppStrings.LANGUAGES[3], // 3 is English
    feedStyle: 'Compact',
    pinEnabled: false,
